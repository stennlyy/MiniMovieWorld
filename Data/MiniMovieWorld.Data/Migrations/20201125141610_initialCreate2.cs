    ...
    public partial class initialCreate2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Actors_Nationalities_NationalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WriterMovies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WriterMovies_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WriterMovies_Writers_WriterId",
                        column: x => x.WriterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryMovie_IsDeleted",
                table: "CategoryMovie",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WriterMovies_IsDeleted",
                table: "WriterMovies",
                column: "IsDeleted");
